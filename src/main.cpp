...
const string strMessageMagic = "GizmoCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GizmoCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "GizmoCoin to the moooon";
        CTransaction txNew;
        txNew.nTime = 1415566111;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415566111;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1168236;
		if(fTestNet)
        {
            block.nNonce   = 1168236;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0903c30d6c79d82d2a878a4dd6d9cf09867b0a64c840d670d9094d9fdd3a071b"));
        block.print();
